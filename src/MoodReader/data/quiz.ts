    ...
    questions: [
      {
        ...
        options: [
          ...
          { text: { zh: '人群笑声', en: 'Laughter' }, reaction: 'neutral', reactionText: { zh: '...你比我勇敢', en: '...You\'re braver than me' } },
        ],
      },
      {
        askExpr: 'neutral',
        ...
        options: [
          ...
          { text: { zh: '看窗外发呆', en: 'Stare out the window' }, reaction: 'happy', reactionText: { zh: '...夜景很安静', en: '...The night is quiet' } },
      ...
      },
      {
        ...
        options: [
          { text: { zh: '很酷', en: 'Cool' }, reaction: 'happy', reactionText: { zh: '......谢谢', en: '......Thanks' } },
          { text: { zh: '有点忧郁', en: 'A bit melancholic' }, reaction: 'neutral', reactionText: { zh: '...也许吧', en: '...Maybe' } },
      ...
      },
      {
        ...
        options: [
          ...
          { text: { zh: '随便你选', en: 'You choose' }, reaction: 'happy', reactionText: { zh: '...那就听这首', en: '...Then listen to this' } },
        ],
      },
    ],
    ...
    questions: [
      {
        ...
        options: [
          ...
          { text: { zh: '不太看书', en: 'Don\'t read much' }, reaction: 'neutral', reactionText: { zh: '那我推荐你一本？', en: 'Can I recommend one?' } },
      ...
      },
      {
        ...
        options: [
          ...
          { text: { zh: '试试摘掉看看？', en: 'Try taking them off?' }, reaction: 'happy', reactionText: { zh: '...其实我摘了什么都看不清', en: '...I can\'t see without them' } },
          { text: { zh: '换个款式试试', en: 'Try a different style' }, reaction: 'neutral', reactionText: { zh: '嗯...有推荐吗？', en: 'Hmm...any suggestions?' } },
      ...
      },
      {
        ...
        options: [
          ...
          { text: { zh: '哪都行，聊天就好', en: 'Anywhere, just chatting' }, reaction: 'happy', reactionText: { zh: '...那就这样吧', en: '...Let\'s do that then' } },
        ],
      },
    ],
    ...
    questions: [
      {
        ...
        options: [
          ...
          { text: { zh: '流行', en: 'Pop' }, reaction: 'neutral', reactionText: { zh: '也行吧', en: 'Fair enough' } },
      ...
      },
      {
        ...
        options: [
          ...
          { text: { zh: '笑起来更帅', en: 'Better when you smile' }, reaction: 'happy', reactionText: { zh: '...那我多笑笑', en: '...I\'ll smile more then' } },
    ...
    questions: [
      {
        ...
        options: [
          ...
          { text: { zh: '都喜欢', en: 'Both' }, reaction: 'neutral', reactionText: { zh: '贪心呢', en: 'Greedy, aren\'t you' } },
      ...
      },
      {
        ...
        options: [
          ...
          { text: { zh: '有点神秘', en: 'A bit mysterious' }, reaction: 'happy', reactionText: { zh: '...是吗', en: '...Am I' } },
          { text: { zh: '很有主见', en: 'Opinionated' }, reaction: 'neutral', reactionText: { zh: '算你说对了', en: 'You got that right' } },
      ...
      },
      {
        ...
        options: [
          { text: { zh: '玫瑰', en: 'Roses' }, reaction: 'neutral', reactionText: { zh: '有点俗...但我收下', en: 'A bit cliché...but I\'ll take them' } },
          ...
          { text: { zh: '你喜欢什么我送什么', en: 'Whatever you want' }, reaction: 'happy', reactionText: { zh: '...还算有诚意', en: '...At least you\'re sincere' } },
        ],
      },
      {
        askExpr: 'happy',
        ...
        options: [
          ...
          { text: { zh: '看心情', en: 'Depends on my mood' }, reaction: 'neutral', reactionText: { zh: '和我很像呢', en: 'You\'re like me' } },
          { text: { zh: '你会想我吗', en: 'Would you miss me?' }, reaction: 'happy', reactionText: { zh: '...不告诉你', en: '...Not telling' } },
